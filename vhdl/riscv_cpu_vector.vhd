...
--
-- O nucleo escalar RV32I opera em conjunto com um caminho de dados VETORIAL
-- de 128 bits EM PARALELO, compartilhando o mesmo front-end (PC, IF/ID,
-- decodificador, deteccao de hazard, freeze e flush).
--
...
entity riscv_cpu_vector is
    Port (
        ...
        -- depuracao vetorial: as 4 lanes do registrador vetorial selecionado (reg_sel_i)
...
architecture Structural of riscv_cpu_vector is
    ...
    component vector_register_file is
        Port ( clk : in STD_LOGIC; we : in STD_LOGIC;
               ...
               dbg_sel : in STD_LOGIC_VECTOR(4 downto 0);
               dbg_data : out STD_LOGIC_VECTOR(127 downto 0));
    end component;
    ...
    signal rf_dbg : STD_LOGIC_VECTOR(31 downto 0);
    ...
    signal vrf_dbg : STD_LOGIC_VECTOR(127 downto 0);
...
begin
    ...
    RF: register_file port map (
        ...
        dbg_sel => reg_sel_i, dbg_data => rf_dbg);
    ...
    VRF: vector_register_file port map (
        ...
        dbg_sel => reg_sel_i, dbg_data => vrf_dbg);
    ...
    -- Le qualquer registrador ESCALAR escolhido por reg_sel_i, a qualquer momento.
    reg_debug_o <= rf_dbg;

    -- As 4 lanes do registrador VETORIAL escolhido por reg_sel_i (mesma selecao).
    vec_lane0_debug_o <= vrf_dbg(31 downto 0);
    vec_lane1_debug_o <= vrf_dbg(63 downto 32);
    vec_lane2_debug_o <= vrf_dbg(95 downto 64);
    vec_lane3_debug_o <= vrf_dbg(127 downto 96);
