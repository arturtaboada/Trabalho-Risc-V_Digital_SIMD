...
--
-- Alteracoes em relacao a versao inicial:
--   * ALUOp(2 bits) substituido por ALUCtrl(4 bits) - a operacao ja' vem
--     resolvida da unidade de controle.
--   * Adicionados os controles Jump, Jalr, Lui e Auipc.
-- ============================================================================
