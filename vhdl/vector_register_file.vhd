...
-- Adicionado BYPASS (write-through): se, no mesmo ciclo, escreve-se em rd e
-- le-se o mesmo endereco, a leitura ja' devolve o dado novo. Isso fecha o
-- hazard de distancia 3 (escrita no WB e leitura no ID no mesmo ciclo), da
-- mesma forma que no banco escalar da Parte 1.
-- ============================================================================
