...
#
# Para converter em hex: use o RARS (https://github.com/TheThirdOne/rars)
# ou o Venus (https://venus.kvakil.me/) — File > Assemble, depois
# salve o dump de memória em formato .hex e carregue na ROM do Digital.
# =============================================================
